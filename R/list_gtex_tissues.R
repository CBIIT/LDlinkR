...
list_gtex_tissues <- function() {
    ...
    all_tissues <- data.frame("tissue_gtex" = c("Adipose - Subcutaneous", "Adipose - Visceral (Omentum)", "Adrenal Gland",
                         ...
                         "tissue_ldexpress" = c("Adipose_Subcutaneous", "Adipose_Visceral_Omentum", "Adrenal_Gland", "Artery_Aorta",
